...
#    # Dim: 8 * 12x12.
    ...
    encoder_config = [encode_cae_l0, encode_cae_l1, encode_cae_l10,
                      encode_cae_l2, encode_cae_l3, encode_cae_l4]
...
#               float(sys.argv[4])]
    ...
    id_code = None
    model = ModelCNN(layers, input, crop_size, l1_reg=0., l2_reg=0.,
                     reg_bias=False, dropout=dropout, id_code=id_code,
                     corruption_level=0.5, rnd=rnd)
    aes_in = [deep_conv_ae_in]
    aes_out = []
